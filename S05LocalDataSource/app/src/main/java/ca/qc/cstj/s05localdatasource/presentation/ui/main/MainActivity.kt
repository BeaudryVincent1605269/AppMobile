...
import ca.qc.cstj.s05localdatasource.presentation.ui.dialog.ContactDialogFragment
            ...
            override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
                ...
                when(direction) {
                    ItemTouchHelper.RIGHT -> {
                        ...
                        contactRecyclerViewAdapter.notifyItemMoved(viewHolder.adapterPosition)
                    }
...
//        Toast.makeText(this, contact.fullName, Toast.LENGTH_LONG).show()
            ...
            ContactDialogFragment().apply { arguments = args }.show(supportFragmentManager, "CONTACT_DIALOG_TAG")
